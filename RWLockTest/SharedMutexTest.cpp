...
TEST_F(SharedMutexTest, 01_ExclusiveReadWriteLock_Test)
{
	const int Nread = 7;
...
*/
TEST_F(SharedMutexTest, 02_SharedReadWriteLock_Test)
{
	const int Nread = 7;
	thread threads[Nread + 1];
...
*/
TEST_F(SharedMutexTest, 03_lock_lock_test)
{
	thread	threads[2];
	int		step = 0;
...
*/
TEST_F(SharedMutexTest, 04_lock_sharedlock_test)
{
	thread	threads[2];
	int		step = 0;
...
/**
	...
	lock 을 또 걸면 대기하는 것 확인
*/
TEST_F(SharedMutexTest, 05_sharedlock_lock_test)
{
	thread	threads[2];
	int		step = 0;
...
*/
TEST_F(SharedMutexTest, 06_sharedlock_sharedlock_test)
{
	thread	threads[2];
	int		step = 0;
...
*/
TEST_F(SharedMutexTest, 07_read_preferring_test)
{
	thread	threads[3];
	int		step = 0;
